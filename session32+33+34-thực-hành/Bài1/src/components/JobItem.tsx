...
export default function JobItem({job, handleChangeStatus, handleClickDelete, handleClickUpdate} : JobItemProps) {
  ...
  return (
    <>
        <li key={job.id}>
            ...
            {!job.status && (
                <button style={{backgroundColor: 'green'}} onClick={() => handleUpdate(job.id)}>
                    Edit
                </button>
            )}
        </li>
