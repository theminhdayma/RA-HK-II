          ...
          <div className="row g-4">
            ...
            >
              <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                ...
                >
                  <img className="img-fluid" src="public/img/haircut.png" alt="" />
                </div>
                <div className="ps-4">
            ...
            >
              <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                <div
                  ...
                  style={{ width: 60, height: 60 }}
                >
                  <img className="img-fluid" src="public/img/beard-trim.png" alt="" />
                </div>
                <div className="ps-4">
            ...
            >
              <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                <div
                  ...
                  style={{ width: 60, height: 60 }}
                >
                  <img className="img-fluid" src="public/img/mans-shave.png" alt="" />
                </div>
                <div className="ps-4">
            ...
            >
              <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                <div
                  ...
                  style={{ width: 60, height: 60 }}
                >
                  <img className="img-fluid" src="public/img/hair-dyeing.png" alt="" />
                </div>
                <div className="ps-4">
            ...
            >
              <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                <div
                  ...
                  style={{ width: 60, height: 60 }}
                >
                  <img className="img-fluid" src="public/img/mustache.png" alt="" />
                </div>
                <div className="ps-4">
            ...
            >
              <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                <div
                  ...
                  style={{ width: 60, height: 60 }}
                >
                  <img className="img-fluid" src="public/img/stacking.png" alt="" />
                </div>
                <div className="ps-4">
